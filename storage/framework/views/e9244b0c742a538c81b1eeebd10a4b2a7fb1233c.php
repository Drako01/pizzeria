...
<section class="body_contacto">
    <div class="form" id="contacto">
        <div class="section-container">
            ...
            <?php endif; ?>
            <div class="row">
                <form action="<?php echo e(route('pages.contacto')); ?>" method="POST" class="formulario" class="col s12">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Git\PHP Avanzado\entrega-final\pizzeria\resources\views/pages/contacto.blade.php ENDPATH**/ ?>